...
class ResourceEnrollmentRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    kind: StrictStr = Field(description="Resource kind. Must be one of the supported kinds (currently `agent`); an unknown value is rejected with a 422. ")
    name: StrictStr = Field(description="Human-readable name; the server derives the slug from it.")
    description: Optional[StrictStr] = None
    wallet_address: Optional[StrictStr] = Field(default=None, description="Declared EVM wallet address for the ghost resource. Stored as a claim (unverified) until the resource is claimed. ")
    __properties: ClassVar[List[str]] = ["kind", "name", "description", "wallet_address"]
