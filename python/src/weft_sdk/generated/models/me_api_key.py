...
class MeApiKey(BaseModel):
    ...
    created_by: Optional[MeApiKeyCreator] = None
    __properties: ClassVar[List[str]] = ["id", "name", "created_at", "last_used_at", "created_by"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "created_by": MeApiKeyCreator.from_dict(obj["created_by"]) if obj.get("created_by") is not None else None
        })
        return _obj
