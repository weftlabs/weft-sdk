...
class AccountBootstrapStatus(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "status", "capabilities", "expires_at", "approval"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "approval": AccountBootstrapApproval.from_dict(obj["approval"]) if obj.get("approval") is not None else None
        })
        return _obj
