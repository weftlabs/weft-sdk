...
class SpendingPolicy(BaseModel):
    ...
    SpendingPolicy
    """ # noqa: E501
    max_tx_usd: StrictStr = Field(description="Maximum USD per single transaction.")
    daily_limit_usd: StrictStr = Field(description="Maximum USD spent in a 24-hour window.")
    weekly_limit_usd: StrictStr = Field(description="Maximum USD spent in a 7-day window.")
    __properties: ClassVar[List[str]] = ["max_tx_usd", "daily_limit_usd", "weekly_limit_usd"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "max_tx_usd": obj.get("max_tx_usd"),
            "daily_limit_usd": obj.get("daily_limit_usd"),
            "weekly_limit_usd": obj.get("weekly_limit_usd")
        })
        return _obj
