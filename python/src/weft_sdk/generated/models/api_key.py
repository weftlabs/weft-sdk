...
class ApiKey(BaseModel):
    ...
    key_prefix: StrictStr = Field(description="First 16 characters of the key for identification")
    last_used_at: Optional[datetime] = None
    revoked_at: Optional[datetime] = None
    created_at: datetime
    __properties: ClassVar[List[str]] = ["id", "name", "key_prefix", "last_used_at", "revoked_at", "created_at"]
