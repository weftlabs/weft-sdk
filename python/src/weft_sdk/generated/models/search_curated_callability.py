...
class SearchCuratedCallability(BaseModel):
    """
    SearchCuratedCallability
    """ # noqa: E501
    state: StrictStr
    missing: List[StrictStr]
    __properties: ClassVar[List[str]] = ["state", "missing"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchCuratedCallability from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchCuratedCallability from a dict"""
        if obj is None:
            return None
