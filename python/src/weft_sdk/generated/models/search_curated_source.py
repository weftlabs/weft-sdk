...
class SearchCuratedSource(BaseModel):
    """
    SearchCuratedSource
    """ # noqa: E501
    catalog: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["catalog", "snapshot_version", "captured_at"]

    @field_validator('catalog')
    def catalog_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['curated_marketplace']):
            raise ValueError("must be one of enum values ('curated_marketplace')")
        return value
