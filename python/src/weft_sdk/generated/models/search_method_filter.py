...
class SearchMethodFilter(BaseModel):
    """
    SearchMethodFilter
    """ # noqa: E501
    ...
    def var_in_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['GET', 'POST', 'PUT', 'PATCH', 'DELETE', 'HEAD', 'OPTIONS']):
                raise ValueError("each list item must be one of ('GET', 'POST', 'PUT', 'PATCH', 'DELETE', 'HEAD', 'OPTIONS')")
        return value
