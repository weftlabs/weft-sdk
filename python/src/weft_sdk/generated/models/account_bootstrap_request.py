...
class AccountBootstrapRequest(BaseModel):
    ...
    oauth_client_id: Optional[StrictStr] = Field(default=None, description="Transitional compatibility for older CLI releases that use OAuth device exchange.")
    requested_scopes: Optional[List[StrictStr]] = Field(default=None, description="Transitional compatibility for older CLI releases that use OAuth device exchange.")
