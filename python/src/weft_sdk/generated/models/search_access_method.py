...
class SearchAccessMethod(BaseModel):
    """
    SearchAccessMethod
    """ # noqa: E501
    access_method_id: StrictStr
    protocol: StrictStr
    scheme: Optional[StrictStr] = None
    network: Optional[StrictStr] = None
    asset: Optional[StrictStr] = None
    asset_decimals: Optional[StrictInt] = None
    price: Dict[str, Any]
    merchant: Optional[Dict[str, Any]] = None
    terms: Optional[Dict[str, Any]] = None
    status: Optional[StrictStr] = None
    weft_fetch: SearchWeftFetchCompatibility
    __properties: ClassVar[List[str]] = ["access_method_id", "protocol", "scheme", "network", "asset", "asset_decimals", "price", "merchant", "terms", "status", "weft_fetch"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['listed', 'observed', 'unavailable']):
            raise ValueError("must be one of enum values ('listed', 'observed', 'unavailable')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of weft_fetch
        if self.weft_fetch:
            _dict['weft_fetch'] = self.weft_fetch.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "asset": obj.get("asset"),
            "asset_decimals": obj.get("asset_decimals"),
            "price": obj.get("price"),
            "merchant": obj.get("merchant"),
            "terms": obj.get("terms"),
            "status": obj.get("status"),
            "weft_fetch": SearchWeftFetchCompatibility.from_dict(obj["weft_fetch"]) if obj.get("weft_fetch") is not None else None
        })
        return _obj
