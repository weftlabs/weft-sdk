...
class ResourceStats(BaseModel):
    ...
    """ # noqa: E501
    total_paid: StrictInt = Field(description="Total atomic units paid out by this resource.")
    total_received: StrictInt = Field(description="Total atomic units received by this resource.")
    payments_made: StrictInt
    payments_received: StrictInt
    unique_counterparties: StrictInt
    first_seen: datetime
    last_active: datetime
    __properties: ClassVar[List[str]] = ["total_paid", "total_received", "payments_made", "payments_received", "unique_counterparties", "first_seen", "last_active"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payments_made": obj.get("payments_made"),
            "payments_received": obj.get("payments_received"),
            "unique_counterparties": obj.get("unique_counterparties"),
