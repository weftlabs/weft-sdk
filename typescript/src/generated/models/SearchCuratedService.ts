 ...
 *
 * @export
 * @interface SearchCuratedService
 */
export interface SearchCuratedService {
    /**
     *
     * @type {string}
     * @memberof SearchCuratedService
     */
    id: string;
    /**
     *
...
/**
 * Check if a given object implements the SearchCuratedService interface.
 */
export function instanceOfSearchCuratedService(value: object): value is SearchCuratedService {
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('name' in value) || value['name'] === undefined) return false;
    return true;
}

export function SearchCuratedServiceFromJSON(json: any): SearchCuratedService {
    return SearchCuratedServiceFromJSONTyped(json, false);
}

export function SearchCuratedServiceFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchCuratedService {
    if (json == null) {
        return json;
    }
    return {
...
export function SearchCuratedServiceToJSON(json: any): SearchCuratedService {
    return SearchCuratedServiceToJSONTyped(json, false);
}

export function SearchCuratedServiceToJSONTyped(value?: SearchCuratedService | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
