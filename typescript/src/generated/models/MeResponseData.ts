 ...
 * @export
 */
export type MeResponseData = { principalType: 'organization' } & AccountDetails | { principalType: 'user' } & UserPrincipal;

export function MeResponseDataFromJSON(json: any): MeResponseData {
    return MeResponseDataFromJSONTyped(json, false);
}

export function MeResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): MeResponseData {
    if (json == null) {
        return json;
    }
    switch (json['principal_type']) {
        case 'organization':
            return Object.assign({}, AccountDetailsFromJSONTyped(json, true), { principalType: 'organization' } as const);
        case 'user':
            return Object.assign({}, UserPrincipalFromJSONTyped(json, true), { principalType: 'user' } as const);
        default:
            return json;
    }
}

export function MeResponseDataToJSON(json: any): any {
    return MeResponseDataToJSONTyped(json, false);
}

export function MeResponseDataToJSONTyped(value?: MeResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['principalType']) {
        case 'organization':
            return Object.assign({}, AccountDetailsToJSON(value), { principalType: 'organization' } as const);
        case 'user':
            return Object.assign({}, UserPrincipalToJSON(value), { principalType: 'user' } as const);
        default:
            return value;
    }
}
