 ...
 *
 * @export
 * @interface SearchCuratedExecution
 */
export interface SearchCuratedExecution {
    /**
     *
     * @type {string}
     * @memberof SearchCuratedExecution
     */
    mode?: SearchCuratedExecutionModeEnum;
}
 ...
 * @export
 */
export const SearchCuratedExecutionModeEnum = {
    Sync: 'sync',
    Async: 'async',
    Stream: 'stream'
} as const;
export type SearchCuratedExecutionModeEnum = typeof SearchCuratedExecutionModeEnum[keyof typeof SearchCuratedExecutionModeEnum];


/**
 * Check if a given object implements the SearchCuratedExecution interface.
 */
export function instanceOfSearchCuratedExecution(value: object): value is SearchCuratedExecution {
    return true;
}

export function SearchCuratedExecutionFromJSON(json: any): SearchCuratedExecution {
    return SearchCuratedExecutionFromJSONTyped(json, false);
}

export function SearchCuratedExecutionFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchCuratedExecution {
    if (json == null) {
        return json;
    }
    return {
...
export function SearchCuratedExecutionToJSON(json: any): SearchCuratedExecution {
    return SearchCuratedExecutionToJSONTyped(json, false);
}

export function SearchCuratedExecutionToJSONTyped(value?: SearchCuratedExecution | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
