 ...
 *
 * @export
 * @interface SearchExecutionModeFilter
 */
export interface SearchExecutionModeFilter {
    /**
     *
     * @type {string}
     * @memberof SearchExecutionModeFilter
     */
    eq?: SearchExecutionModeFilterEqEnum;
    /**
     *
     * @type {Array<string>}
     * @memberof SearchExecutionModeFilter
     */
    _in?: Array<SearchExecutionModeFilterInEnum>;
}
 ...
 * @export
 */
export const SearchExecutionModeFilterEqEnum = {
    Sync: 'sync',
    Async: 'async',
    Stream: 'stream'
} as const;
export type SearchExecutionModeFilterEqEnum = typeof SearchExecutionModeFilterEqEnum[keyof typeof SearchExecutionModeFilterEqEnum];

/**
 * @export
 */
export const SearchExecutionModeFilterInEnum = {
    Sync: 'sync',
    Async: 'async',
    Stream: 'stream'
} as const;
export type SearchExecutionModeFilterInEnum = typeof SearchExecutionModeFilterInEnum[keyof typeof SearchExecutionModeFilterInEnum];


/**
 * Check if a given object implements the SearchExecutionModeFilter interface.
 */
export function instanceOfSearchExecutionModeFilter(value: object): value is SearchExecutionModeFilter {
    return true;
}

export function SearchExecutionModeFilterFromJSON(json: any): SearchExecutionModeFilter {
    return SearchExecutionModeFilterFromJSONTyped(json, false);
}

export function SearchExecutionModeFilterFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchExecutionModeFilter {
    if (json == null) {
        return json;
    }
    return {
...
export function SearchExecutionModeFilterToJSON(json: any): SearchExecutionModeFilter {
    return SearchExecutionModeFilterToJSONTyped(json, false);
}

export function SearchExecutionModeFilterToJSONTyped(value?: SearchExecutionModeFilter | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
