 ...
 *
 * @export
 * @interface SearchStringSetFilter
 */
export interface SearchStringSetFilter {
    /**
     *
     * @type {string}
     * @memberof SearchStringSetFilter
     */
    eq?: string;
    /**
     *
...
/**
 * Check if a given object implements the SearchStringSetFilter interface.
 */
export function instanceOfSearchStringSetFilter(value: object): value is SearchStringSetFilter {
    return true;
}

export function SearchStringSetFilterFromJSON(json: any): SearchStringSetFilter {
    return SearchStringSetFilterFromJSONTyped(json, false);
}

export function SearchStringSetFilterFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchStringSetFilter {
    if (json == null) {
        return json;
    }
    return {
...
export function SearchStringSetFilterToJSON(json: any): SearchStringSetFilter {
    return SearchStringSetFilterToJSONTyped(json, false);
}

export function SearchStringSetFilterToJSONTyped(value?: SearchStringSetFilter | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
