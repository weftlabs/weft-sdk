...
export interface RateLimitResponse {
     ...
     */
    error: RateLimitResponseErrorEnum;
    /**
     *
     * @type {string}
     * @memberof RateLimitResponse
 ...
 * @export
 */
export const RateLimitResponseErrorEnum = {
    TooManyRequests: 'too_many_requests'
} as const;
export type RateLimitResponseErrorEnum = typeof RateLimitResponseErrorEnum[keyof typeof RateLimitResponseErrorEnum];
