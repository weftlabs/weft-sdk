 ...
 *
 * @export
 * @interface SearchCuratedOperation
 */
export interface SearchCuratedOperation {
    /**
     *
     * @type {string}
     * @memberof SearchCuratedOperation
     */
    id: string;
    /**
     *
...
/**
 * Check if a given object implements the SearchCuratedOperation interface.
 */
export function instanceOfSearchCuratedOperation(value: object): value is SearchCuratedOperation {
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('name' in value) || value['name'] === undefined) return false;
    return true;
}

export function SearchCuratedOperationFromJSON(json: any): SearchCuratedOperation {
    return SearchCuratedOperationFromJSONTyped(json, false);
}

export function SearchCuratedOperationFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchCuratedOperation {
    if (json == null) {
        return json;
    }
    return {
...
export function SearchCuratedOperationToJSON(json: any): SearchCuratedOperation {
    return SearchCuratedOperationToJSONTyped(json, false);
}

export function SearchCuratedOperationToJSONTyped(value?: SearchCuratedOperation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
