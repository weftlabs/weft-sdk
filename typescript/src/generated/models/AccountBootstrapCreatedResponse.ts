...
import type { AccountBootstrapCreated } from './AccountBootstrapCreated';
import {
    AccountBootstrapCreatedFromJSON,
    AccountBootstrapCreatedFromJSONTyped,
    AccountBootstrapCreatedToJSON,
    AccountBootstrapCreatedToJSONTyped,
} from './AccountBootstrapCreated';

/**
 *
 * @export
 * @interface AccountBootstrapCreatedResponse
 */
export interface AccountBootstrapCreatedResponse {
    /**
     *
     * @type {AccountBootstrapCreated}
     * @memberof AccountBootstrapCreatedResponse
     */
    data: AccountBootstrapCreated;
}

/**
 * Check if a given object implements the AccountBootstrapCreatedResponse interface.
 */
export function instanceOfAccountBootstrapCreatedResponse(value: object): value is AccountBootstrapCreatedResponse {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function AccountBootstrapCreatedResponseFromJSON(json: any): AccountBootstrapCreatedResponse {
    return AccountBootstrapCreatedResponseFromJSONTyped(json, false);
}

export function AccountBootstrapCreatedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountBootstrapCreatedResponse {
    if (json == null) {
        return json;
    }
    return {

        'data': AccountBootstrapCreatedFromJSON(json['data']),
    };
}

export function AccountBootstrapCreatedResponseToJSON(json: any): AccountBootstrapCreatedResponse {
    return AccountBootstrapCreatedResponseToJSONTyped(json, false);
}

export function AccountBootstrapCreatedResponseToJSONTyped(value?: AccountBootstrapCreatedResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': AccountBootstrapCreatedToJSON(value['data']),
    };
}
