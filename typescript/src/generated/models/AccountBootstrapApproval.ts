 ...
 *
 * @export
 * @interface AccountBootstrapApproval
 */
export interface AccountBootstrapApproval {
    /**
     *
     * @type {string}
     * @memberof AccountBootstrapApproval
     */
    method: AccountBootstrapApprovalMethodEnum;
    /**
     *
     * @type {number}
     * @memberof AccountBootstrapApproval
 ...
 * @export
 */
export const AccountBootstrapApprovalMethodEnum = {
    EmailLink: 'email_link'
} as const;
export type AccountBootstrapApprovalMethodEnum = typeof AccountBootstrapApprovalMethodEnum[keyof typeof AccountBootstrapApprovalMethodEnum];


/**
 * Check if a given object implements the AccountBootstrapApproval interface.
 */
export function instanceOfAccountBootstrapApproval(value: object): value is AccountBootstrapApproval {
...
export function AccountBootstrapApprovalFromJSON(json: any): AccountBootstrapApproval {
    return AccountBootstrapApprovalFromJSONTyped(json, false);
}

export function AccountBootstrapApprovalFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountBootstrapApproval {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountBootstrapApprovalToJSON(json: any): AccountBootstrapApproval {
    return AccountBootstrapApprovalToJSONTyped(json, false);
}

export function AccountBootstrapApprovalToJSONTyped(value?: AccountBootstrapApproval | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
