...
import {
    MeResponseDataFromJSON,
    MeResponseDataFromJSONTyped,
    MeResponseDataToJSON,
    MeResponseDataToJSONTyped,
} from './MeResponseData';
...
export function MeResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): MeResponse {
    ...
    return {
        ...
        'data': MeResponseDataFromJSON(json['data']),
    };
}
...
export function MeResponseToJSONTyped(value?: MeResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'data': MeResponseDataToJSON(value['data']),
    };
}
