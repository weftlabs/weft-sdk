...
/**
 * Free helper links for the upstream provider. GET these URLs.
 * Do not send them through `weft_fetch`.
 *
 * @export
 * @interface SearchHelperDocs
 */
export interface SearchHelperDocs {
    /**
     *
     * @type {string}
     * @memberof SearchHelperDocs
     */
    website?: string;
    /**
     *
...
/**
 * Check if a given object implements the SearchHelperDocs interface.
 */
export function instanceOfSearchHelperDocs(value: object): value is SearchHelperDocs {
    return true;
}

export function SearchHelperDocsFromJSON(json: any): SearchHelperDocs {
    return SearchHelperDocsFromJSONTyped(json, false);
}

export function SearchHelperDocsFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchHelperDocs {
    if (json == null) {
        return json;
    }
    return {
        ...
        'llmsTxt': json['llms_txt'] == null ? undefined : json['llms_txt'],
    };
}

export function SearchHelperDocsToJSON(json: any): SearchHelperDocs {
    return SearchHelperDocsToJSONTyped(json, false);
}

export function SearchHelperDocsToJSONTyped(value?: SearchHelperDocs | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
