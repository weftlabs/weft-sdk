 ...
 *
 * @export
 * @interface SearchCuratedCallability
 */
export interface SearchCuratedCallability {
    /**
     *
     * @type {string}
     * @memberof SearchCuratedCallability
     */
    state: SearchCuratedCallabilityStateEnum;
    /**
     *
     * @type {Array<string>}
     * @memberof SearchCuratedCallability
 ...
 * @export
 */
export const SearchCuratedCallabilityStateEnum = {
    Complete: 'complete',
    Incomplete: 'incomplete'
} as const;
export type SearchCuratedCallabilityStateEnum = typeof SearchCuratedCallabilityStateEnum[keyof typeof SearchCuratedCallabilityStateEnum];


/**
 * Check if a given object implements the SearchCuratedCallability interface.
 */
export function instanceOfSearchCuratedCallability(value: object): value is SearchCuratedCallability {
    if (!('state' in value) || value['state'] === undefined) return false;
    if (!('missing' in value) || value['missing'] === undefined) return false;
    return true;
}

export function SearchCuratedCallabilityFromJSON(json: any): SearchCuratedCallability {
    return SearchCuratedCallabilityFromJSONTyped(json, false);
}

export function SearchCuratedCallabilityFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchCuratedCallability {
    if (json == null) {
        return json;
    }
    return {
...
export function SearchCuratedCallabilityToJSON(json: any): SearchCuratedCallability {
    return SearchCuratedCallabilityToJSONTyped(json, false);
}

export function SearchCuratedCallabilityToJSONTyped(value?: SearchCuratedCallability | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
