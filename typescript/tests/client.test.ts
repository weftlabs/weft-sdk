...
import { FetchResponsePaymentStatusEnum } from "../src/generated/models/FetchResponse";
...
describe("WeftClient", () => {
  ...
  it("retrieves SIWX results with a zero ceiling and preserves the artifact receipt", async () => {
    const fetchApi = vi.fn(
