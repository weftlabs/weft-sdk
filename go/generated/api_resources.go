...
func (r ApiEnrollResourceRequest) ResourceEnrollmentRequest(resourceEnrollmentRequest ResourceEnrollmentRequest) ApiEnrollResourceRequest {
	r.resourceEnrollmentRequest = &resourceEnrollmentRequest
	return r
}

func (r ApiEnrollResourceRequest) Execute() (*ResourceEnrollmentResponse, *http.Response, error) {
	return r.ApiService.EnrollResourceExecute(r)
}

/*
EnrollResource Self-enroll a ghost resource (public, no auth)
...
func (a *ResourcesAPIService) EnrollResourceExecute(r ApiEnrollResourceRequest) (*ResourceEnrollmentResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ResourceEnrollmentResponse
	)
	...
	if r.resourceEnrollmentRequest == nil {
		return localVarReturnValue, nil, reportError("resourceEnrollmentRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.resourceEnrollmentRequest
