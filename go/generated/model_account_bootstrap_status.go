...
// checks if the AccountBootstrapStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountBootstrapStatus{}

// AccountBootstrapStatus struct for AccountBootstrapStatus
type AccountBootstrapStatus struct {
	...
	Approval  AccountBootstrapApproval `json:"approval"`
}

type _AccountBootstrapStatus AccountBootstrapStatus
...
func (o *AccountBootstrapStatus) GetApproval() AccountBootstrapApproval {
	if o == nil {
		var ret AccountBootstrapApproval
		return ret
	}
...
func (o AccountBootstrapStatus) MarshalJSON() ([]byte, error) {
...
func (o AccountBootstrapStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AccountBootstrapStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountBootstrapStatus := _AccountBootstrapStatus{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAccountBootstrapStatus)

	if err != nil {
		return err
	}

	*o = AccountBootstrapStatus(varAccountBootstrapStatus)

	return err
}

type NullableAccountBootstrapStatus struct {
	value *AccountBootstrapStatus
	isSet bool
}

func (v NullableAccountBootstrapStatus) Get() *AccountBootstrapStatus {
	return v.value
}

func (v *NullableAccountBootstrapStatus) Set(val *AccountBootstrapStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountBootstrapStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountBootstrapStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountBootstrapStatus(val *AccountBootstrapStatus) *NullableAccountBootstrapStatus {
	return &NullableAccountBootstrapStatus{value: val, isSet: true}
}

func (v NullableAccountBootstrapStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountBootstrapStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
