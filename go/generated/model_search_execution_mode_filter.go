...
// checks if the SearchExecutionModeFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchExecutionModeFilter{}

// SearchExecutionModeFilter struct for SearchExecutionModeFilter
type SearchExecutionModeFilter struct {
	Eq *string  `json:"eq,omitempty"`
	In []string `json:"in,omitempty"`
}

// NewSearchExecutionModeFilter instantiates a new SearchExecutionModeFilter object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewSearchExecutionModeFilter() *SearchExecutionModeFilter {
	this := SearchExecutionModeFilter{}
	return &this
}

// NewSearchExecutionModeFilterWithDefaults instantiates a new SearchExecutionModeFilter object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewSearchExecutionModeFilterWithDefaults() *SearchExecutionModeFilter {
	this := SearchExecutionModeFilter{}
	return &this
}

// GetEq returns the Eq field value if set, zero value otherwise.
func (o *SearchExecutionModeFilter) GetEq() string {
	if o == nil || IsNil(o.Eq) {
		var ret string
		return ret
	}
...
func (o *SearchExecutionModeFilter) GetEqOk() (*string, bool) {
	if o == nil || IsNil(o.Eq) {
		return nil, false
	}
	return o.Eq, true
...
func (o *SearchExecutionModeFilter) HasEq() bool {
	if o != nil && !IsNil(o.Eq) {
		return true
	}
...
func (o *SearchExecutionModeFilter) SetEq(v string) {
	o.Eq = &v
}

// GetIn returns the In field value if set, zero value otherwise.
func (o *SearchExecutionModeFilter) GetIn() []string {
	if o == nil || IsNil(o.In) {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SearchExecutionModeFilter) GetInOk() ([]string, bool) {
	if o == nil || IsNil(o.In) {
		return nil, false
	}
	return o.In, true
...
func (o *SearchExecutionModeFilter) HasIn() bool {
	if o != nil && !IsNil(o.In) {
		return true
	}
...
func (o *SearchExecutionModeFilter) SetIn(v []string) {
	o.In = v
}

func (o SearchExecutionModeFilter) MarshalJSON() ([]byte, error) {
...
func (o SearchExecutionModeFilter) ToMap() (map[string]interface{}, error) {
...
type NullableSearchExecutionModeFilter struct {
	value *SearchExecutionModeFilter
	isSet bool
}

func (v NullableSearchExecutionModeFilter) Get() *SearchExecutionModeFilter {
	return v.value
}

func (v *NullableSearchExecutionModeFilter) Set(val *SearchExecutionModeFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchExecutionModeFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchExecutionModeFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchExecutionModeFilter(val *SearchExecutionModeFilter) *NullableSearchExecutionModeFilter {
	return &NullableSearchExecutionModeFilter{value: val, isSet: true}
}

func (v NullableSearchExecutionModeFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSearchExecutionModeFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
