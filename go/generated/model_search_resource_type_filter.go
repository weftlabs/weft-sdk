...
// checks if the SearchResourceTypeFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchResourceTypeFilter{}

// SearchResourceTypeFilter Resource-type constraint. Set exactly one of `eq` / `in`.
type SearchResourceTypeFilter struct {
...
func (o SearchResourceTypeFilter) MarshalJSON() ([]byte, error) {
...
func (o SearchResourceTypeFilter) ToMap() (map[string]interface{}, error) {
...
type NullableSearchResourceTypeFilter struct {
	value *SearchResourceTypeFilter
	isSet bool
}

func (v NullableSearchResourceTypeFilter) Get() *SearchResourceTypeFilter {
	return v.value
}

func (v *NullableSearchResourceTypeFilter) Set(val *SearchResourceTypeFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchResourceTypeFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchResourceTypeFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchResourceTypeFilter(val *SearchResourceTypeFilter) *NullableSearchResourceTypeFilter {
	return &NullableSearchResourceTypeFilter{value: val, isSet: true}
}

func (v NullableSearchResourceTypeFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSearchResourceTypeFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
