...
func NewMeResponse(data MeResponseData) *MeResponse {
	this := MeResponse{}
	this.Data = data
	return &this
}
...
func (o *MeResponse) GetData() MeResponseData {
	if o == nil {
		var ret MeResponseData
		return ret
	}
...
func (o *MeResponse) GetDataOk() (*MeResponseData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *MeResponse) SetData(v MeResponseData) {
	o.Data = v
}
