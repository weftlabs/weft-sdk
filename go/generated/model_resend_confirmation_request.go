...
// checks if the ResendConfirmationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResendConfirmationRequest{}

// ResendConfirmationRequest struct for ResendConfirmationRequest
type ResendConfirmationRequest struct {
	Email string `json:"email"`
}

type _ResendConfirmationRequest ResendConfirmationRequest

// NewResendConfirmationRequest instantiates a new ResendConfirmationRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewResendConfirmationRequest(email string) *ResendConfirmationRequest {
	this := ResendConfirmationRequest{}
	this.Email = email
	return &this
}

// NewResendConfirmationRequestWithDefaults instantiates a new ResendConfirmationRequest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewResendConfirmationRequestWithDefaults() *ResendConfirmationRequest {
	this := ResendConfirmationRequest{}
	return &this
}

// GetEmail returns the Email field value
func (o *ResendConfirmationRequest) GetEmail() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *ResendConfirmationRequest) GetEmailOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Email, true
...
func (o *ResendConfirmationRequest) SetEmail(v string) {
	o.Email = v
}

func (o ResendConfirmationRequest) MarshalJSON() ([]byte, error) {
...
func (o ResendConfirmationRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["email"] = o.Email
	return toSerialize, nil
}

func (o *ResendConfirmationRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varResendConfirmationRequest := _ResendConfirmationRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResendConfirmationRequest)

	if err != nil {
		return err
	}

	*o = ResendConfirmationRequest(varResendConfirmationRequest)

	return err
}

type NullableResendConfirmationRequest struct {
	value *ResendConfirmationRequest
	isSet bool
}

func (v NullableResendConfirmationRequest) Get() *ResendConfirmationRequest {
	return v.value
}

func (v *NullableResendConfirmationRequest) Set(val *ResendConfirmationRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableResendConfirmationRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableResendConfirmationRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResendConfirmationRequest(val *ResendConfirmationRequest) *NullableResendConfirmationRequest {
	return &NullableResendConfirmationRequest{value: val, isSet: true}
}

func (v NullableResendConfirmationRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResendConfirmationRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
