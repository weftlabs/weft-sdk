...
*/
func (a *DocumentationAPIService) GetOpenApiDocument(ctx context.Context) ApiGetOpenApiDocumentRequest {
	return ApiGetOpenApiDocumentRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return string
func (a *DocumentationAPIService) GetOpenApiDocumentExecute(r ApiGetOpenApiDocumentRequest) (string, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DocumentationAPIService.GetOpenApiDocument")
	if err != nil {
